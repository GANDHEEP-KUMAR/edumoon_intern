...
console.log("from localstorage:",localStorage.getItem("kumar"));
const jsontest=JSON.stringify(data);
localStorage.setItem("kumar",jsontest);
console.log("from localstorage:",localStorage.getItem("kumar"));
console.log("from localstorage:",JSON.parse(localStorage.getItem("kumar")));
